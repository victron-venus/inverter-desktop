...
import HomePanels from '../features/desktop/HomePanels.vue'
...
describe('desktop HomePanels', () => {
  it('shows sensors header but collapsed by default', () => {
    const wrapper = mount(HomePanels, { props: baseProps })
  ...
  it('shows covers collapsed, expands on click', async () => {
    const wrapper = mount(HomePanels, {
      props: {
        ...baseProps,
