<template>
  ...
  >
    ...
    <div class="flex items-center gap-1">
      <span class="text-slate-500 dark:text-slate-500">Uptime:</span>
    ...
    <div class="flex items-center gap-1">
      ...
      ></div>
      <span class="text-slate-500 dark:text-white">MQTT</span>
    </div>

    <span class="opacity-30 mx-0.5">|</span>
    <span class="text-slate-500 dark:text-slate-500 font-medium">Desktop {{ appVersion }}</span>
